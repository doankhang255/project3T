...
# Bien the PMI-k (Daille 1994): cong them (k-1)*log2(P(x,y)) vao PMI goc de
# phat cac cap qua it lan dong xuat hien thuc te, thay vi chi dua vao ty le
# co_df/df nhu PMI thuan (xem giai thich chi tiet trong compute_pmi cua
...
OUTPUT_DICTIONARY_PARQUET_PATH = LEXICON_DATA_DIR / "candidate_ngram_terms_dictionary_pmi_k.parquet"
OUTPUT_DICTIONARY_CSV_PATH = LEXICON_DATA_DIR / "candidate_ngram_terms_dictionary_pmi_k.csv"
OUTPUT_SEED_RESOLUTION_CSV_PATH = LEXICON_DATA_DIR / "pmi_seed_resolution_pmi_k.csv"
