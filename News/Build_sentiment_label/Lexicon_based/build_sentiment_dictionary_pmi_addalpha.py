...
# Bien the Add-alpha (Laplace-style) smoothing: cong pseudo-count alpha vao ca
# 3 so dem (co_df, df_candidate, df_seed) truoc khi tinh ty le trong cong thuc
# PMI. Khac voi PMI thuan/PMI-k (coi cap chua tung dong xuat hien la "thieu du
# lieu", loai khoi trung binh), add-alpha luon ra 1 gia tri huu han - cap chua
# dong xuat hien duoc coi la bang chung sentiment trai chieu YEU, khong phai
# NaN (xem giai thich chi tiet trong compute_pmi cua build_sentiment_dictionary_pmi.py).
SMOOTHING_ALPHA = 1.0
...
OUTPUT_DICTIONARY_PARQUET_PATH = LEXICON_DATA_DIR / "candidate_ngram_terms_dictionary_pmi_addalpha.parquet"
OUTPUT_DICTIONARY_CSV_PATH = LEXICON_DATA_DIR / "candidate_ngram_terms_dictionary_pmi_addalpha.csv"
OUTPUT_SEED_RESOLUTION_CSV_PATH = LEXICON_DATA_DIR / "pmi_seed_resolution_addalpha.csv"
